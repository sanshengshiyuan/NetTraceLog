...
int main() {
    ...
    conf.pub_key = "04827405069030E26A211C973C8710E6FBE79B5CAA364AC111FB171311902277537F8852EADD17EB339EB7CD0BA2490A58CDED2C702DFC1EFC7EDB544B869F039C";
    // priv_key = "FAA5BBE9017C96BF641D19D0144661885E831B5DDF52539EF1AB4790C05E665E";
    ...
    std::string str = "hello this is a test log";
    for (int i = 0; i < 10; ++i) {
